...
.dark .form-card-icon { background:rgba(16,185,129,0.12); }
...
<div class="page-bg">
    <div style="max-width:640px;margin:0 auto;">
        ...
        <div class="page-banner">
            ...
            <p>Buat jadwal kegiatan baru untuk absensi santri</p>
        </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    <p class="form-card-title">Informasi Jadwal</p>
                    <p class="form-card-sub">Isi detail kegiatan absensi</p>
                </div>
            </div>
                ...
                <form action="{{ route('jadwal.store') }}" method="POST">
                        ...
                        <div class="hari-grid">
                            ...
                            <div>
                                <input type="checkbox" name="hari[]" value="{{ $k }}" id="hari_{{ $k }}"
                                    class="hari-checkbox" {{ in_array($k, (array)old('hari', [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-section" style="margin-bottom:0;">
                        ...
                        <div class="form-group" style="margin-bottom:0;">
                            ...
                            <textarea name="keterangan" class="form-textarea" placeholder="Tambahkan catatan atau keterangan untuk jadwal ini...">{{ old('keterangan') }}</textarea>
                        </div>
                    </div>
